...
void case_0x93()
{
    ...
    param_5 = (long)uVar4;
    uVar23 = *(ulong *)(vm_code + (ulong)(b - uVar11 * uVar22));
    *(ulong *)(vm_code + (ulong)(a - pc_base * uVar22)) =
         uVar23 ^ *(ulong *)(vm_code + (ulong)(c  - uVar4 * uVar22));
    vm_code = *(long *)vm_context->vmCode;
...
LAB_00147f98:
    ...
    if ((uVar18 ^ (long)*(int *)(vm_code + (ulong)(aXorValue - a * uVar22))) != uVar25) {
      aNext = uVar29;
    }
    goto LAB_001498c8;
