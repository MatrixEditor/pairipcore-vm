...
void case_0x09()
{
  ...
  ode_length = *(uint *)vm_context->vmCodeLength;
    ...
    auVar42 = func_0x0016a340(*(undefined4 *)(vm_code + (ulong)(a - uVar4 * uVar33)),
                              *(undefined4 *)(vm_code + (ulong)(c - pc_base * uVar33)));
    *(undefined4 *)(vm_code + (ulong)(b  - uVar28 * uVar33)) = extraout_s0;
